            ...
            <div className="container position-relative px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        <div className="post-heading" style={{textAlign:"justify"}}>
                    ...
                    <div className="col-md-10 col-lg-8 col-xl-7" style={{textAlign:"justify"}}>
                        ...
                        <p>
                          ...
                          <div className="d-flex justify-content-end">
                              <span >
                                {isLiked ? <i className="fa-solid fa-thumbs-up fa-3x" onClick={() => setIsLiked(false)}></i> 
                                  :  <i className="fa-regular fa-thumbs-up fa-3x" onClick={() => setIsLiked(true)} ></i>}
